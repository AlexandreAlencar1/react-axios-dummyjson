...
public class ProductController {
    ...
    @PostMapping("/products") // salvar o produto
    public ResponseEntity<ProductModel> saveProduct(@RequestBody @Valid ProductRecordDto productRecordDto) {
        var productModel = new ProductModel();
        BeanUtils.copyProperties(productRecordDto, productModel); // recebe Dto e passa pra Model
    ...
    @GetMapping("/products/{id}") // colsultar por id
    ...
    @PutMapping("/products/{id}") // editar por id
